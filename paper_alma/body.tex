...
In the college admissions market, the desirability of a school correlates with its competitiveness, meaning that college application represents a challenging risk allocation problem: Applicants must weigh competitive, attractive ``reach schools'' against less attractive ``safety schools'' where admission is a safer bet and ``target schools'' in the middle. The difficulty of the college application problem, along with the perceived importance of college admissions to future career outcomes, drives demand for a lucrative industry known as admissions consulting. In the US, students pay private consultants an average of \$200 per hour for assistance in preparing application materials, estimating their admissions odds, and deciding which schools to apply to \cite{sklarow2018}. However, when admissions consultants advise their clients on where to apply, they typically rely on qualitative heuristics, such as balancing applications evenly between safety and reach schools \cite{jeon2015,peck2021}. How effective are these heuristics, and can a formal statement of the college application problem help us improve upon them? 
...
In the present study, we formulate the student's college application strategy as the following combinatorial optimization problem:
...
Our analysis also shows that the valuation of the college application problem is sublinear in the budget $h$, and that the marginal value of application is greatest to students with low admissions probability at the schools currently in their portfolio. This finding suggests an economic explanation for the underwhelming efficacy of behavioral nudges, such as application fee waivers, designed to encourage talented low-income students to apply to selective universities \cite{gurantzetal2021}. 

...
% Following three paragraphs should be two
In competitive college admissions markets, the challenge of balancing risk and reward across the schools in one's application portfolio makes the optimal college application strategy a matter of perennial popular interest. Research in the social sciences has revealed systematic differences in students' application strategies: Those from wealthy backgrounds tend to apply to many colleges, including so-called ``reach schools'' where their probability of admission is relatively low, whereas low-income students tend to apply to just a few schools, and favor those where admission is a safer bet \cite{hartlaubandschneider2012,vanhuizenandalessie2019}. Does this phenomenon reflect psychological differences in students' risk aversion, or rational decisionmaking under different resource constraints? 
...
\subsection{Diminishing returns to application and fee waiver programs}
